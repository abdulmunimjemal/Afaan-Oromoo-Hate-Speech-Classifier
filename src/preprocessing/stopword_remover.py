class StopwordRemover:
    DEFAULT_STOPWORDS = {
        ...
        'agarsiisa', 'mulhisa', 'ni', 'hin', 'haa', 'wal', 'h', 'jedhu', 'jedhe', 'tokkoo', 'tokko', 'tae', 'keessaa', 'bakka', 'yaa', 'gabaase', 'beeksiseera', 'yaadatama', 'Feesbuukii', 'Feesbuukii', 'odeeffannoo', 'subiskiraayib', 'godha', 'godhaa', 'hordofaa', 'mulhisa', 'hi'
    }
